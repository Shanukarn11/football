...
var SportsZone = function(){
	...
	var dzTheme = function(){
		 'use strict';
		 var loadingImage = '<img loading="lazy" src="images/loading.gif">';
	...
	function trialdate(value){
		...
		var WebsiteLaunchDate = new Date(value);
		console.log("WebsiteLaunchDate")
		console.log(WebsiteLaunchDate)
		monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
		WebsiteLaunchDate.setMonth(WebsiteLaunchDate.getMonth() + 1);
		WebsiteLaunchDate =  WebsiteLaunchDate.getDate() + " " + monthNames[WebsiteLaunchDate.getMonth()] + " " + WebsiteLaunchDate.getFullYear(); 
		/* Website Launch Date END */ 
		return WebsiteLaunchDate
	}
	var handleCountDown = function(WebsiteLaunchDate){
		...
		{  $('.countdown').each(function() {
			var enddate=$(this).find('.trialmatchdate').html()
			var a=$(this).countdown({date: trialdate(enddate)})
